...
export const hu: Dictionary = {
  ...
  hero: {
    ...
    titleMain: "Megbízható szoftverek,",
    titleGradient: "karakteres márkák.",
    description: "Megbízható, modern webes alkalmazásokat építek, és segítek induló vállalkozásoknak komplex ötleteiket letisztult, hatásos digitális termékké formálni. ELTE fizikus háttér, 1 100+ kiszolgált ügyfél nemzetközileg.",
    stats: {
  ...
  story: {
    ...
    fiverrTooltip: "Top-Rated a Fiverr-en • 1 100+ befejezett projekt • 100% pontos szállítás",
    timeline: [
      {
        sol: "01. FEJEZET",
  ...
  skills: {
    ...
    categories: [
      ...
      },
      {
        ...
        skills: ["PostgreSQL", "SQLite", "Redis", "SQLAlchemy 2.0", "Drizzle ORM", "Alembic", "asyncpg", "libSQL"],
      },
      {
        id: "devops",
  ...
  testimonials: {
    ...
    description: "Több mint 1 100 nemzetközi megrendelés és 400+ igazolt értékelés a Fiverr-en (4.8★ Top-Rated).",
    verifiedBadge: "IGAZOLT FIVERR ÉRTÉKELÉS",
    ratingBadge: "★ 4.8 TOP-RATED A FIVERR-EN (1 100+ ÜGYFÉL)",
    verifyFiverrLink: "400+ ellenőrzött értékelés megtekintése a Fiverr profilomon ↗",
    feedback: [
      {
        id: "feedback-fintech",
        quote:
        ...
        client: "Fintech Startup Alapító (USA) — Fiverr Rendelés",
      },
      {
        id: "feedback-saas",
        quote:
        ...
        client: "SaaS Platform Igazgató (Egyesült Királyság) — Fiverr Rendelés",
      },
    ],
  },
  contact: {
