...
export const en: Dictionary = {
  ...
  hero: {
    ...
    titleMain: "Building solid software,",
    titleGradient: "crafting distinctive brands.",
    description: "I build reliable, accessible full-stack web applications and help startups translate complex ideas into clear, memorable digital products. Physics background from ELTE, with 1,100+ clients served worldwide.",
    stats: {
  ...
  story: {
    ...
    fiverrTooltip: "Top-Rated on Fiverr • 1,100+ completed projects • 100% on-time delivery",
    timeline: [
      {
        sol: "CHAPTER 01",
  ...
  testimonials: {
    ...
    description: "Over 1,100 international orders and 400+ reviews on Fiverr with a 4.8★ rating.",
    verifiedBadge: "VERIFIED FIVERR REVIEW",
    ratingBadge: "★ 4.8 TOP-RATED ON FIVERR (1,100+ CLIENTS)",
    verifyFiverrLink: "View all 400+ reviews on Fiverr ↗",
    feedback: [
      {
        id: "feedback-fintech",
        quote:
