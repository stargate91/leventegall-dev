...
export const en: Dictionary = {
  ...
  hero: {
    greeting: "FULL-STACK DEVELOPER & PROBLEM SOLVER",
    titleMain: "Building clean software,",
    titleGradient: "crafting memorable brands.",
    description:
      "I build fast, dependable full-stack web apps and help founders turn ideas into products people actually remember. Grounded in ELTE physics, backed by 1,100+ international clients.",
    stats: {
    ...
    categories: [
      {
        id: "languages",
        title: "Languages",
        description: "Primary programming and formatting languages from business logic to data modeling and documentation.",
